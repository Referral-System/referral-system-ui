    ...
    const handleCorrectData = (referrals: any ) => {
        ...
        const columns = [
            { field: "referral_status_id", headerName: "Status", width: 108, renderCell: (params: any) => (
                    <Chip className={ 'center' } label={params.value} size="small" variant="outlined" color={progress(params)}/>
                ),
            },
            ...
            { field: "tech_stacks", headerName: "Tech Stacks", width: 310, renderCell: (params: any) => (
                    <div className='tech_tag_container'>
                        {params.value.map((tech: string) => (<span className='tag'>{ tech }</span>))}
                    </div>
                ),
            },
            { field: "referred_by", headerName: "Referred_by", width: 180 },
            { field: "ta_recruiter", headerName: "Ta Recruiter", width: 180 },
